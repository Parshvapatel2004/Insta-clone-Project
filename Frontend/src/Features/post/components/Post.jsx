    ...
    <div className="post">
      <div className="user">
        <div className="img-wrapper">
          <img
            src="https://plus.unsplash.com/premium_photo-1771722492550-6e749b9d6a0b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxMXx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          />
        </div>
      ...
      <img
        src="https://images.unsplash.com/photo-1771777400722-3e0a83a15144?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxOXx8fGVufDB8fHx8fA%3D%3D"
        alt=""
      />
      <div className="icons">
        <div className="left">
          <button>
            <svg
              //   className={props.post.isLiked ? "like" : ""}
